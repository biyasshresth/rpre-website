        ...
        <div className={styles.content}>
          ...
          <FadeIn delay={0.2} direction="up">
            <p className={styles.bodyCopy}>
              There is no arrival. The horizon doesn't stop retreating. And yet
              — that's the gift. The creative life asks us not to finish, but to
              remain faithful to the practice regardless of outcome.
            </p>
            <p className={[styles.bodyCopy, styles.bodyCopyLast].join(" ")}>
              Every line drawn, every idea tested, every failure absorbed — they
              accumulate into something no single work could hold. They become{" "}
          ...
          <FadeIn delay={0.4} direction="up">
            <div className={styles.quoteCard}>
              ...
              <span className={styles.quoteAttrib}>
                — A designer's personal creed
              </span>
            </div>
          </FadeIn>
